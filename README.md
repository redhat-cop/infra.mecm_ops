...
At the Microsoft MECM Infrastructure Operations collection, our mission is to produce and maintain simple, flexible,
and powerful open-source software tailored to Microsoft Configuration Manager infrastructure automation and operational management.

We welcome members from all skill levels to participate actively in our open, inclusive, and vibrant community.
Whether you are an expert or just beginning your journey with Ansible and Microsoft MECM infrastructure operations,
...
See the [changelog](https://github.com/redhat-cop/infra.mecm_ops/tree/main/CHANGELOG.rst).
